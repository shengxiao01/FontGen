...
layer05_input = x[:,5 * image_size:6 * image_size].reshape((batch_size, 1, basis_size, basis_size))
layer06_input = x[:,5 * image_size:6 * image_size].reshape((batch_size, 1, basis_size, basis_size))
layer07_input = x[:,5 * image_size:6 * image_size].reshape((batch_size, 1, basis_size, basis_size))
...
layer2_input = T.concatenate([layer10.output.flatten(2), layer11.output.flatten(2), layer12.output.flatten(2), layer13.output.flatten(2)
                              , layer14.output.flatten(2), layer15.output.flatten(2), layer16.output.flatten(2), layer17.output.flatten(2)],
                              axis = 1)
...
params = (layer4.params 
        + layer3.params 
        + layer2.params 
        + layer10.params + layer11.params + layer12.params + layer13.params + layer14.params + layer15.params + layer16.params + layer17.params
        + layer00.params + layer01.params + layer02.params + layer03.params + layer04.params + layer05.params + layer06.params + layer07.params)
